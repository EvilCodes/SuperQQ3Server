...
import com.ucai.superqq.utils.JdbcUtils;
...
public class SuperQQDao implements ISuperQQDao {
	...
	public static void main(String[] args) {
		...
		case 19:
			...
			break;
		case 20:
			isSuccess=dao.deleteGroupMemeber("1405588", "aa");
	...
	@Override
	public boolean updateGroupAvatar(String groupName, String groupAvatar) {
		PreparedStatement statement=null;
		Connection connection = JdbcUtils.getConnection();
		String sql="update "+I.Group.TABLE_NAME
			+" set "+I.Group.AVATAR+"=?"
		...
		try {
			statement=connection.prepareStatement(sql);
			statement.setString(1, groupAvatar);
			statement.setString(2, groupName);
			int count = statement.executeUpdate();
			return count==1;
		} catch (SQLException e) {
