...
import com.ucai.superqq.dao.ISuperQQDao;
import com.ucai.superqq.dao.SuperQQDao;
import com.ucai.superqq.servlet.I;
...
public class SuperQQBiz implements ISuperQQBiz {
	...
	public ContactBean[] findContactsByUserName(String userName, int pageId,
			int pageSize) {
		ContactBean[] contacts = dao.findContactsByUserName(userName, pageId,
				pageSize);
		return contacts;
	}
	...
	public UserBean[] findContactListByMyuid(int myuid, int pageId, int pageSize) {
		UserBean[] contacts = dao.findContactListByMyuid(myuid, pageId,
				pageSize);
		return contacts;
	}
	...
	@Override
	public boolean addGroupMembers(String groupName, String members) {
	...
	@Override
	public boolean deleteGroupMemeber(String groupName, String memberName) {
		boolean isSuccess = dao.deleteGroupMemeber(groupName, memberName);
		return isSuccess;
	}
